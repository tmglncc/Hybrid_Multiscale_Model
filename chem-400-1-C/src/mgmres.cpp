...
void MGMRES::atx_cr(int n, int nz_num, double a[], int ia[], int ja[], double x[], double w[])
...
void MGMRES::atx_st(int n, int nz_num, double a[], int ia[], int ja[], double x[], double w[])
...
void MGMRES::ax_cr(int n, int nz_num, double a[], int ia[], int ja[], double x[], double w[])
...
void MGMRES::ax_st(int n, int nz_num, double a[], int ia[], int ja[], double x[], double w[])
...
void MGMRES::diagonal_pointer_cr(int n, int nz_num, int ia[], int ja[], int ua[])
...
void MGMRES::ilu_cr(int n, int nz_num, int ia[], int ja[], double a[], int ua[], double l[])
...
void MGMRES::lus_cr(int n, int nz_num, int ia[], int ja[], double l[], int ua[], double r[], double z[])
...
void MGMRES::mgmres_st(int n, int nz_num, int ia[], int ja[], double a[], double x[], double rhs[], int itr_max, int mr, double tol_abs, double tol_rel)
...
//
{
	...
	for ( itr = 1; itr <= itr_max; itr++ )
	{
		...
		for ( k = 1; k <= mr; k++ )
		{
			...
			ax_st ( n, nz_num, a, ia, ja, v+(k-1)*n, v+k*n );
...
void MGMRES::mult_givens(double c, double s, int k, double g[])
...
void MGMRES::pmgmres_ilu_cr(int n, int nz_num, int ia[], int ja[], double a[], double x[], double rhs[], int itr_max, int mr, double tol_abs, double tol_rel)
...
//
{
	...
	for ( itr = 0; itr < itr_max; itr++ )
	{
		...
		for ( k = 0; k < mr; k++ )
		{
			...
			ax_cr ( n, nz_num, a, ia, ja, v+k*n, v+(k+1)*n );
...
double MGMRES::r8vec_dot(int n, double a1[], double a2[])
...
double* MGMRES::r8vec_uniform_01(int n, int *seed)
...
void MGMRES::rearrange_cr(int n, int nz_num, int ia[], int ja[], double a[])
